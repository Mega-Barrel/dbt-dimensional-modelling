...
SELECT
    {{ dbt_utils.star(
            ...
            relation_alias='f_sales',
                ...
                "creditcard_key", "ship_address_key",
    ...
    {{ dbt_utils.star(
            ...
            relation_alias='d_order_status',
            except=["order_status_key"]
        )
    }},

    {{ dbt_utils.star(
            from=ref('dim_date'),
            relation_alias='d_date',
            except=["date_key"]
        )
    }}
FROM
